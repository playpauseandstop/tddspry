# -*- coding: utf-8 -*-
#
# tddspry documentation build configuration file, created by
# sphinx-quickstart on Sun May 10 00:26:12 2009.
#
...
latex_documents = [
  ('index', 'tddspry.tex', u'tddspry Documentation',
